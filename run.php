...
/**
 * The ROOT directory of the installer.
 *
 * @var string
 */
define('Icybee\Installer\ROOT', rtrim(__DIR__, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR);
 ...
 * @var string
 */
define('Icybee\Installer\ASSETS', ROOT . 'public' . DIRECTORY_SEPARATOR);
 ...
 * @var string
 */
define('Icybee\Installer\WEBSITE_CONFIG_ROOT', \ICanBoogie\DOCUMENT_ROOT . 'protected' . DIRECTORY_SEPARATOR . 'all' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR);
...
(
	...
	(
		...
		'modules paths' => array
		(
			\Icybee\ROOT . 'modules' . DIRECTORY_SEPARATOR,
